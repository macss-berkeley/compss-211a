  ...
  function render(){
    ...
    return title('Flashcards','Answer from memory, then reveal the answer.')+`
      ...
      ${card?`<article class="flashcard" data-card-id="${card.id}">
        ...
        <a class="flash-skill" href="#skill/${card.skill}">Practise this skill</a>
